...
// Example usage
const topFivePlayers = getTopFivePlayers();
console.log('Top 5 Rated NRL Players:');
topFivePlayers.forEach((player, index) => {
    console.log(`${index + 1}. ${player.playerName} (${player.team}) - Rating: ${player.averageRating}`);
}); 